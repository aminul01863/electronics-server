...
client.connect(err => {
    const serviceCollection = client.db("electronicServer").collection("services");
    const bookingCollection = client.db("electronicServer").collection("booking");
    const bookListCollection = client.db("electronicServer").collection("bookingList");
    const reviewCollection = client.db("electronicServer").collection("review");
    const adminCollection = client.db("electronicServer").collection("admin");
